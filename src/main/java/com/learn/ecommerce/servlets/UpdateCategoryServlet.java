...
public class UpdateCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String catTitle=(request.getParameter("catTitle")).trim();
            String catDescription=(request.getParameter("catDescription")).trim();
            
            System.out.println(catId+"-----------------"+catTitle+"------------------"+catDescription);
            
            
            Category newCat =new Category();
            newCat.setCategoryId(catId);
            newCat.setCategoryTitle(catTitle);
            newCat.setCategoryDescription(catDescription);
            
          CategoryDao cdao=new CategoryDao(FactoryProvider.getFactory());
            
         boolean f = cdao.updateCategory(newCat);
